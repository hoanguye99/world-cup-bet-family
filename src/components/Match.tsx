    ...
    <>
      <div className='container-match'>
        ...
        <div className='content-match'>
          <h3>{new Date(props.match.date).toLocaleString("vi",{weekday: 'long',  month: 'long', day: 'numeric',hour:'numeric', minute:'numeric'})}</h3>
          <div className='teams'>
      ...
      <Modal title="Thông tin trận đấu" open={isModalOpen} onOk={handleOk} onCancel={handleCancel}>
